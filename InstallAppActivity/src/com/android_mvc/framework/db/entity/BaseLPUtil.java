...
public class BaseLPUtil
{
    ...
    protected static String FWDateFormat = "yyyy/MM/dd";
     ...
     * 論理Calendarから物理textへ
     */
    public static String encodeCalendarToTextYMD(Calendar calendar)
    {
        return DateTimeUtil.calendar2string(calendar, FWDateFormat);
    }
